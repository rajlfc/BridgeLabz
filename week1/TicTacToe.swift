...
func winUser( a:  [ [String] ]) -> Bool
{
    ...
    {
        if a[0][0] == "x" && a[0][1] == "x" && a[0][2] == "x" || a[1][0] == "x" && a[1][1] == "x" && a[1][2] == "x" || a[2][0] == "x" && a[2][1] == "x" && a[2][2] == "x" || a[0][0] == "x" && a[1][0] == "x" && a[2][0] == "x" || a[0][1] == "x" && a[1][1] == "x" && a[1][2] == "x" || a[2][0] == "x" && a[2][1] == "x" && a[2][2] == "x" || a[0][2] == "x" && a[1][1] == "x" && a[2][0] == "x"
         {
...
func winComp(a: [ [String] ]) -> Bool
{
    ...
    {
        if a[0][0] == "o" && a[0][1] == "o" && a[0][2] == "o" || a[1][0] == "o" && a[1][1] == "o" && a[1][2] == "o" || a[2][0] == "o" && a[2][1] == "o" && a[2][2] == "o" || a[0][0] == "o" && a[1][0] == "o" && a[2][0] == "o" || a[0][1] == "o" && a[1][1] == "o" && a[1][2] == "o" || a[2][0] == "o" && a[2][1] == "o" && a[2][2] == "o" || a[0][2] == "o" && a[1][1] == "o" && a[2][0] == "o"
        {
