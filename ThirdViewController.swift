...
struct Register: Encodable {
    ...
    let lastName: String
    let service:String = "advance"
    let username : String
    let email : String
    let password : String
    let emailVerified : Bool = true
    let id : String = "none"
}
...
//        imageview.image = UIImage(named: "Image-3")?.alpha(0.4)
//        self.view.sendSubviewToBack(imageview)
        EmailField.setPadding()
        EmailField.setBottomBorder()
        password.setPadding()
        password.setBottomBorder()
        ConfirmPassField.setPadding()
        ConfirmPassField.setBottomBorder()
        securityfield.setPadding()
        securityfield.setBottomBorder()
...
//        }
        ...
        let register = Register(firstName: name!, lastName: name!, username: name!, email: email!, password: passwordval!)
        print(register)
