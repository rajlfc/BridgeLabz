...
//            }
    ...
    @IBAction func onsave(_ sender: Any) {
        ...
        newUser.setValue(view.backgroundColor?.encode(), forKey: "color")
        ...
        do {
            ...
            {
                storetitle.append(titlefield.text)
                storedescription.append(notefield.text)
                storecolor.append((view.backgroundColor?.toHexString())!)
            }
        } catch {
            print("Failed saving")
        }
        if Connectivity.isConnectedToInternet == false
        {
            UserDefaults.standard.set(storetitle, forKey: "titlee")
            UserDefaults.standard.set(storedescription,forKey: "descriptioon")
            UserDefaults.standard.set(storecolor,forKey: "colorr")
            UserDefaults.standard.set(true, forKey: "checknotee")
        }
        // create Note API//
//
